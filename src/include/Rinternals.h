...
struct sxpinfo_struct {
    ...
    unsigned int promise_gc: 1; /* for tracing: this SEXP should be counted as promise after GC */
    unsigned int promise_level: 16; /* for tracing: level the promise was created on */
}; /*		    Tot: 32 +2+16 */
